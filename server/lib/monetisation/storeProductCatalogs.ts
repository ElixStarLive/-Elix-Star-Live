/**
 * Store product catalogues — Apple App Store vs Google Play (server).
 *
 * Must stay aligned with src/lib/storeProductCatalogs.ts.
 * Never merge catalogues into one request/validate-as-either list.
 */
