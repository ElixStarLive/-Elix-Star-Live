  ...
  const placeholder = (
    <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#111113] gap-4 pointer-events-none z-[1]">
      {creatorAvatar ? (
        ...
        <div
          className="rounded-full bg-[#D4AF37]/20 flex items-center justify-center shrink-0"
          style={{ width: INLINE_LIVE_PLACEHOLDER_AVATAR_PX, height: INLINE_LIVE_PLACEHOLDER_AVATAR_PX }}
        >
            ...
            {Array.from({ length: 8 }).map((_, i) => {
              ...
              if (!h) {
                return (
                  <div
                    key={`empty-${i}`}
                    className="relative min-h-0 overflow-hidden rounded-none border border-[#D4AF37]/25 bg-[#111113] flex flex-col items-center justify-center"
                  >
                    <span className="text-white/30 text-lg font-light">+</span>
              ...
              return (
                <div
                  key={h.userId}
                  className="relative min-h-0 overflow-hidden rounded-none border border-[#D4AF37]/35 bg-[#111113]"
                >
