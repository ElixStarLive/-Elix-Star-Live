                ...
                {isCamOff && !featuredHost && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-[#111113] z-[5]">
                    {(user?.avatar || myAvatar) ? (
                      <img src={user?.avatar || myAvatar || ''} alt="" className="w-16 h-16 rounded-full border-2 border-[#D4AF37]/40 object-cover object-center" />
                    ) : (
                      <div className="w-16 h-16 rounded-full border-2 border-[#D4AF37]/40 bg-[#111113] flex items-center justify-center">
                    ...
                    <div className="flex items-start justify-between gap-2">
                      <div className="pointer-events-auto flex flex-col gap-2">
                        ...
                        <div className="px-0 py-1 animate-luxury-fade-in relative">
                          ...
                          />
                          {currentUniverse && (
                            <div className="mt-1 flex items-center gap-1 bg-[#111113]/90 rounded-full px-2.5 py-1 border border-[#D4AF37]/80 shadow-sm pointer-events-auto relative z-20">
          ...
          {!isCreatorParticipant && (
            <div className="flex items-end gap-2 w-full max-w-[480px] pointer-events-auto">
              ...
              <div className="flex flex-col items-center gap-0.5">
                ...
                >
                  <BarChart3 size={20} className="text-[#2F6BFF] relative z-[2]" strokeWidth={2.2} />
                </button>
              ...
              <div className="space-y-1 pb-4">
                ...
                {filteredCreators.length === 0 && creatorsLoading ? (
                  <div className="py-6 flex justify-center">
                    <div className="w-5 h-5 border-2 border-[#D4AF37]/40 border-t-transparent rounded-full animate-spin" />
                  </div>
                ) : null}
                {filteredCreators.length === 0 && creatorsLoadFailed ? (
                  <div className="py-6 flex justify-center">
                    <button type="button" onClick={() => loadCreators()} className="px-3 py-1.5 rounded-lg bg-[#D4AF37]/20 border border-[#D4AF37]/40 text-[#D4AF37] text-[10px] font-bold active:scale-95">
                      Retry
                    </button>
                  </div>
                ) : null}
                ...
                <button
                  ...
                  className={`h-9 rounded-lg text-[11px] active:scale-95 transition-all ${
                    ...
                    (miniProfileFollowsThem === true ||
                      ...
                      : 'bg-[#D4AF37] text-black font-black hover:bg-[#D4AF37]/90'
                  }`}
                >
                  {miniProfile?.id &&
                  (miniProfileFollowsThem === true ||
            ...
            <div className="bg-[#111113]/95 backdrop-blur-md rounded-t-2xl h-[36vh] flex flex-col shadow-2xl overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto no-scrollbar px-4 pb-4 min-h-0">
                {viewerListMode === 'topGifters' ? (
                  ...
                  <>
                {pendingInvite && (
                  <div className="mb-3 flex items-center gap-2.5 w-full py-1 px-2 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/30">
                    <div
        ...
        <>
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-4 pb-4 no-scrollbar min-h-0">
               {/* Team Status Card */}
               <div className="bg-white/5 rounded-xl p-3 border border-[#D4AF37]/20 relative overflow-hidden">
               ...
               <div className="mt-3">
                 ...
                 <div className="space-y-1">
                   ...
                   {heartMembers.map((m, i) => (
                     <div key={m.user_id} className="flex items-center gap-2.5 px-3 py-2 rounded-lg bg-[#D4AF37]/5 border border-[#D4AF37]/15">
                       <div className="w-5 text-center font-bold text-[10px] text-[#E8D5A3]/60">{i + 1}</div>
                       <img src={m.avatar_url || '/royce/elix-mark.svg'} alt="" className="w-7 h-7 rounded-full object-cover border border-[#D4AF37]/20" />
                       <div className="flex-1 min-w-0">
               ...
               {/* Total Gift Coins */}
               <div className="bg-white/5 rounded-xl p-3 border border-[#D4AF37]/20 mt-2">
               ...
               <div className="mt-3">
                 ...
                 <div className="space-y-1">
                   ...
                   {topGifters.map((g, i) => (
                     <div key={g.user_id} className="flex items-center gap-2.5 px-3 py-2 rounded-lg bg-[#D4AF37]/5 border border-[#D4AF37]/15">
                       <div className="w-5 text-center font-bold text-[10px] text-[#E8D5A3]/60">{i + 1}</div>
                       <img src={g.avatar_url || '/royce/elix-mark.svg'} alt="" className="w-7 h-7 rounded-full object-cover border border-[#D4AF37]/20" />
                       <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="bg-white/5 rounded-xl p-3 border border-[#D4AF37]/20">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="bg-[#D4AF37]/10 text-[#D4AF37] text-[7px] font-bold px-1.5 py-0.5 rounded-full border border-[#D4AF37]/20">
                  ...
                  <div className="grid grid-cols-4 gap-1.5">
                    {creatorStickers.map((sticker) => (
                      <div key={sticker.id} className="aspect-square rounded-lg bg-white/5 border border-[#D4AF37]/10 relative overflow-hidden group">
                    ...
                    {creatorStickers.length < 20 && (
                      <button
                        className="aspect-square rounded-lg bg-white/5 hover:bg-white/10 active:scale-95 transition-all flex items-center justify-center border border-dashed border-[#D4AF37]/30 relative overflow-hidden"
