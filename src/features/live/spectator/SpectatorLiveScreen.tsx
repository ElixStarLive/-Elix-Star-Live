  ...
  if (spectatorGate === 'loading') {
    return (
      <div className="fixed inset-0 bg-black flex justify-center">
        <div className="relative w-full max-w-[480px] h-full bg-[#0B0B0E] flex flex-col items-center justify-center gap-4 p-6">
          <div className="w-10 h-10 border-2 border-[#5F0AE3] border-t-transparent rounded-full animate-spin" />
          ...
          <div className="flex flex-col sm:flex-row gap-2 mt-2">
            {!streamEndedReceived && (
              <button
                ...
                className="px-6 py-2.5 rounded-lg bg-[#5F0AE3]/20 border border-[#5F0AE3]/50 text-[#D2ADF8] font-semibold"
              >
                Retry connection
              </button>
            )}
            <button
              ...
              className="px-6 py-2.5 rounded-lg bg-[#5F0AE3] text-black font-semibold"
            >
              Go back
            </button>
          </div>
              ...
              >
                    ...
                    >
                      <div className="relative w-5 h-5 flex items-center justify-center flex-shrink-0">
                        <svg viewBox="0 0 40 44" className="absolute inset-0 w-full h-full drop-shadow-md">
                          ...
                          <defs><linearGradient id="vsGradSpectator" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#DB0A3B"/><stop offset="50%" stopColor="#8B0000"/><stop offset="100%" stopColor="#1E90FF"/></linearGradient></defs>
                        </svg>
                ...
                <div className="relative w-full flex-none flex flex-col overflow-hidden" style={{ height: LIVE_BATTLE_VIDEO_HEIGHT }}>
                  <div className="flex-1 min-h-0 flex flex-col relative">
                    ...
                    <div className="absolute inset-0 flex flex-row gap-0">
                      <div className="flex-1 basis-0 min-w-0 h-full overflow-hidden relative bg-[#0B0B0E]">
                        <video
                          ref={videoRef}
                        ...
                        />
                        {!hasStream && (
                          <div className="absolute inset-0 z-[1] flex flex-col items-center justify-center gap-2 bg-[#0B0B0E]">
                            {hostAvatar ? (
                              ...
                              <div className="w-16 h-16 rounded-full bg-[#0B0B0E] flex items-center justify-center">
                                <span className="text-2xl font-black text-[#D2ADF8]">{(hostName || 'H').charAt(0).toUpperCase()}</span>
                              </div>
                            )}
                      ...
                      <div
                        className="flex-1 basis-0 min-w-0 h-full overflow-hidden relative bg-[#0B0B0E]"
                      >
                        <video
                        ...
                        {!hasOpponentStream && (
                          <div className="absolute inset-0 z-[1] flex flex-col items-center justify-center gap-2 bg-[#0B0B0E]">
                            {spectatorBattle.opponentName ? (
                              <div className="w-16 h-16 rounded-full bg-[#0B0B0E] flex items-center justify-center">
                                <span className="text-2xl font-black text-[#D2ADF8]">{spectatorBattle.opponentName.charAt(0).toUpperCase()}</span>
                              </div>
                            ) : (
                              <div className="w-16 h-16 rounded-full bg-[#0B0B0E] flex items-center justify-center">
                                <span className="text-2xl font-black text-[#D2ADF8]">O</span>
                              </div>
                            )}
                        ...
                        {lastOpponentGift && (
                          <div className="absolute bottom-1 right-1 z-20 pointer-events-none flex items-center">
                            <div className="w-5 h-5 rounded-full bg-[#0B0B0E] border border-[#5F0AE3]/40 overflow-hidden flex items-center justify-center drop-shadow-md">
                ...
                {showOpponentPanel && spectatorBattle.opponentRoomId && (
                  <div className="fixed inset-0 z-[200]" onClick={() => setShowOpponentPanel(false)}>
                    ...
                    <div
                      className="absolute left-1/2 -translate-x-1/2 w-[calc(100%-24px)] max-w-[456px] bg-[#0B0B0E] rounded-2xl overflow-hidden shadow-xl border border-white/10 animate-[slideInFromBottom_0.2s_ease-out]"
                    ...
                    >
                      <div className="px-3.5 py-3 flex items-center gap-3">
                        {(opponentProfile?.avatarUrl) ? (
                          ...
                          <div className="w-10 h-10 rounded-full bg-[#0B0B0E] flex items-center justify-center flex-shrink-0">
                            <span className="text-sm font-black text-[#D2ADF8]">
                        ...
                        <div className="flex gap-2 flex-shrink-0">
                          ...
                          {battleStreamIds?.opponentUserId && (
                            <button
                              type="button"
                              className="flex items-center px-3 py-2 rounded-full border border-[#5F0AE3]/40 active:scale-95 transition-transform"
                              onClick={(e) => {
                                e.stopPropagation();
                            ...
                            >
                              <span className="text-[#D2ADF8] font-bold text-[11px]">Profile</span>
                            </button>
                          )}
                        </div>
                      </div>
              ...
              return (
                <>
                  <video
                    ...
                    style={{ opacity: hostCamOff ? 0 : 1, backgroundColor: '#0B0B0E' }}
                  />
                  {hostCamOff && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 bg-[#0B0B0E] z-[5]">
                      {hostAvatar ? (
                        ...
                        <div className="w-10 h-10 rounded-full bg-[#0B0B0E] flex items-center justify-center">
                          <span className="text-[#D2ADF8]/60 text-sm font-bold">{hostName.slice(0, 1)}</span>
                        </div>
                      )}
                    </div>
                  )}
                  <button
                    ...
                    className="absolute top-0.5 left-0.5 z-10 rounded bg-black/55 p-0.5 border border-[#5F0AE3]/45 pointer-events-auto active:scale-95"
                  >
                ...
                <>
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 bg-[#0B0B0E] z-[5]">
                    {(viewerAvatar || user?.avatar) ? (
                      ...
                      <div className="w-10 h-10 rounded-full bg-[#0B0B0E] flex items-center justify-center">
                        <span className="text-[#D2ADF8]/60 text-sm font-bold">{(viewerName || '?').charAt(0)}</span>
                      </div>
                    )}
                  </div>
                  )}
                ...
                <>
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 bg-[#0B0B0E] z-[5]">
                    {h.avatar ? (
                      ...
                      <div className="w-10 h-10 rounded-full bg-[#0B0B0E] flex items-center justify-center">
                        <span className="text-[#D2ADF8]/60 text-sm font-bold">{(h.name || '?').charAt(0)}</span>
                      </div>
                    )}
              ...
              >
                ...
                {featuredLive && (
                  <>
                    ...
                    <button
                      ...
                      onClick={(e) => { e.stopPropagation(); setFeaturedUserId(null); }}
                      className="absolute top-1 left-1 z-20 flex items-center gap-0.5 px-1.5 py-0.5 rounded bg-black/60 border border-[#5F0AE3]/50 pointer-events-auto active:scale-95"
                    >
                      <ArrowLeftRight className="w-3 h-3 text-[#D2ADF8]" strokeWidth={2.5} />
                ...
                {hostCamOff && !featuredLive && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-[#0B0B0E] z-[5]">
                    {hostAvatar ? (
                      <img src={hostAvatar} alt="" className="w-16 h-16 rounded-full object-cover object-center border-2 border-[#5F0AE3]/40" />
                    ) : (
                      <div className="w-16 h-16 rounded-full bg-[#5F0AE3]/20 flex items-center justify-center border-2 border-[#5F0AE3]/40">
                        <span className="text-[#D2ADF8] font-bold text-2xl">{hostName.slice(0, 1).toUpperCase()}</span>
                      </div>
                    )}
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center gap-4" style={{ transform: 'translateX(15mm)' }}>
                    <div className="w-24 h-24 rounded-full overflow-hidden">
                      {hostAvatar ? (
                        ...
                        <div className="w-full h-full bg-[#5F0AE3]/20 flex items-center justify-center">
                          <span className="text-[#D2ADF8] font-bold text-3xl">{hostName.slice(0, 1).toUpperCase()}</span>
                        </div>
                      )}
                    </div>
                    {!user?.id ? (
                      <>
                        ...
                        <button
                          ...
                          className="mt-2 px-5 py-2.5 rounded-lg bg-[#5F0AE3] text-black font-semibold text-sm"
                        >
                          Log in
                        </button>
                      </>
                      ...
                      <>
                        <div className="flex items-center gap-2">
                          <div className="w-4 h-4 border-2 border-[#5F0AE3] border-t-transparent rounded-full animate-spin" />
                        ...
                        {showRetryButton && (
                          <button
                            ...
                            className="mt-2 px-5 py-2 rounded-lg bg-[#5F0AE3]/20 border border-[#5F0AE3]/40 text-[#D2ADF8] text-sm font-medium"
                          >
                            Tap to retry
                          </button>
                        )}
                  ...
                  {slots.slice(0, 8).map((slot, i) => {
                    ...
                    return (
                      <div
                        ...
                        className={`relative bg-[#0B0B0E] flex flex-col items-center justify-center overflow-hidden p-0 min-h-0 border border-[#C9A96E]/40 ${cellSpeaking ? 'elix-speaking-pulse' : ''} ${liveHost ? 'cursor-pointer' : ''}`}
                      >
                        {renderSlot(slot)}
                      </div>
                    );
...
{/* Bottom bar — above gift video so Gift/Invite/Share/More stay tappable */}
          ...
          <div className="w-full max-w-[480px] px-3 pt-0 bg-transparent">
            <div className="flex items-end gap-2 w-full max-w-[480px] pointer-events-auto">
              ...
              >
                ...
                />
                {inputValue.trim() ? (
                  <button type="submit" title="Send message" className="text-[#D2ADF8] flex-shrink-0">
                    <Send size={16} />
                  </button>
                ) : null}
              </form>
              ...
              >
                <div className="relative w-10 h-10 flex items-center justify-center rounded-full bg-black/35 backdrop-blur-sm">
                  <BarChart3 size={20} className="text-[#5F0AE3] shrink-0" strokeWidth={2.2} />
                </div>
                <span className="text-[10px] font-semibold text-[#5F0AE3] mt-0.5">Poll</span>
              </button>
              ...
              >
                <div className="relative w-10 h-10 flex items-center justify-center rounded-full bg-black/35 backdrop-blur-sm">
                  <span className="flex items-center justify-center w-full h-full relative z-[2]">
                    <UserPlus size={20} className="text-[#D2ADF8] shrink-0" strokeWidth={2} />
                  </span>
                </div>
                <span className="text-[10px] font-semibold text-[#D2ADF8] mt-0.5">
              ...
              >
                ...
                <span className="text-[10px] font-semibold text-[#D2ADF8] mt-0.5">Gift</span>
              </button>
              <button
                type="button"
                title="Share"
              ...
              >
                ...
                <span className="text-[10px] font-semibold text-[#D2ADF8] mt-0.5">Share</span>
              </button>
              <button
                type="button"
                title="More options"
              ...
              >
                ...
                <span className="text-[10px] font-semibold text-[#D2ADF8] mt-0.5">More</span>
              </button>
              </div>
            </div>
          </div>
        ...
        {pendingBattleInvite && (
          <div className="fixed left-0 right-0 z-[100000] pointer-events-none flex justify-center px-3" style={{ top: 'calc(env(safe-area-inset-top, 0px) + 64px)' }}>
            <div className="pointer-events-auto w-full max-w-[440px] flex items-center gap-2.5 py-1 px-2 rounded-full bg-[#0B0B0E]/95 backdrop-blur-md border border-[#5F0AE3]/40 shadow-2xl">
              <div
              ...
              >
                {pendingBattleInvite.hostAvatar ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-[#D2ADF8] font-bold">{pendingBattleInvite.hostName.slice(0, 1).toUpperCase()}</div>
                )}
              </div>
        ...
        {showCoHostPanel && (
          <>
            ...
            <div className="fixed bottom-0 left-0 right-0 z-[99999] pointer-events-auto max-w-[480px] mx-auto">
              <div className="bg-[#0B0B0E]/95 backdrop-blur-md rounded-t-2xl h-[40vh] flex flex-col shadow-2xl overflow-hidden pb-safe" onClick={(e) => e.stopPropagation()}>
                <div className="flex justify-center pt-2 pb-1"><div className="w-10 h-1 bg-white/20 rounded-full" /></div>
                <div className="flex items-center justify-center px-4 py-2">
                  <div className="flex items-center gap-1.5">
                    <Crown size={14} className="text-[#D2ADF8]" strokeWidth={1.8} />
                  ...
                  {pendingCoHostInvite ? (
                    <div className="w-full flex items-center gap-2.5 px-2 py-2 rounded-lg bg-white/[0.03] flex-shrink-0">
                      <div
                        ...
                        style={{ width: SHARE_PANEL_AVATAR_PX, height: SHARE_PANEL_AVATAR_PX }}
                      >
                        {pendingCoHostInvite.hostAvatar ? <img src={pendingCoHostInvite.hostAvatar} alt="" className="w-full h-full object-cover" /> : <div className="w-full h-full flex items-center justify-center text-[#D2ADF8] font-bold">{pendingCoHostInvite.hostName.slice(0, 1).toUpperCase()}</div>}
                      </div>
                      <div className="flex-1 min-w-0 text-left">
                    ...
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <button
                        ...
                        onClick={() => { sendCohostJoinRequest(); }}
                        className={`w-full py-3 rounded-xl font-bold text-sm ${joinRequested ? 'bg-white/10 text-white/40 cursor-not-allowed' : 'bg-[#5F0AE3] text-black active:scale-95'}`}
                      >
        ...
        {showFanClub && (
          <>
            ...
            <div className="fixed bottom-0 left-0 right-0 z-[99999] pointer-events-auto max-w-[480px] mx-auto">
              <div
                className="bg-[#0B0B0E]/95 rounded-t-2xl p-3 pb-safe h-[40vh] overflow-y-auto no-scrollbar shadow-2xl w-full "
                onClick={(e) => e.stopPropagation()}
              >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="bg-white/5 rounded-xl p-3 border border-[#5F0AE3]/20">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="bg-[#5F0AE3]/10 text-[#D2ADF8] text-[7px] font-bold px-1.5 py-0.5 rounded-full border border-[#5F0AE3]/20">SUBSCRIBER ONLY</span>
                      </div>
                      <div className="grid grid-cols-4 gap-1">
                        {['🔥', '💎', '👑', '🚀', '💯', '🎉', '💖', '👀'].map((emoji, i) => (
                          <button
                            key={i}
                            className="aspect-square rounded-lg bg-white/5 hover:bg-white/10 active:scale-95 transition-all flex items-center justify-center text-sm border border-[#5F0AE3]/10 relative overflow-hidden group"
                            onClick={() => {
                              const newMessage: LiveMessage = {
                          ...
                          >
                            ...
                            {!isMember && (
                              <div className="absolute inset-0 bg-[#0B0B0E]/60 backdrop-blur-[1px] flex items-center justify-center">
                        ...
                        <button
                          className="aspect-square rounded-lg bg-white/5 hover:bg-white/10 active:scale-95 transition-all flex items-center justify-center border border-[#5F0AE3]/10 relative overflow-hidden group"
                          onClick={() => {
                            if (!isMember) return;
                        ...
                        >
                          <div className="flex flex-col items-center gap-0.5">
                            <PlusCircle size={12} className="text-[#D2ADF8]/50 group-hover:text-[#D2ADF8] transition-colors" />
                            <span className="text-[6px] text-[#D2ADF8]/50 font-bold uppercase">Upload</span>
                          </div>
                          {!isMember && (
                            <div className="absolute inset-0 bg-[#0B0B0E]/60 backdrop-blur-[1px] flex items-center justify-center">
                              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-80"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
        ...
        {showGiftPanel && (
          <>
            ...
            <div className="fixed bottom-0 left-0 right-0 pointer-events-auto max-w-[480px] mx-auto" style={{ zIndex: 99999 }}>
              {spectatorBattle?.active && (
                <div className="px-3 pb-2 pt-1 flex items-center justify-center gap-2 bg-[#0B0B0E]/95 rounded-t-xl">
                  <div className="flex rounded-full overflow-hidden border border-[#5F0AE3]/40">
                    <button
                      type="button"
                      title="Gift left side"
                      onClick={() => setSpectatorGiftBattleTarget('host')}
                      className={`px-4 py-1.5 text-[10px] font-bold transition-colors ${spectatorGiftBattleTarget === 'host' ? 'bg-[#DB0A3B]/90 text-white' : 'bg-[#0B0B0E] text-white/70'}`}
                    >
                      Left
                    </button>
                    <button
                      ...
                      className={`px-4 py-1.5 text-[10px] font-bold transition-colors ${spectatorGiftBattleTarget === 'opponent' ? 'bg-[#1E90FF]/90 text-white' : 'bg-[#0B0B0E] text-white/70'}`}
                    >
                      Right
                    </button>
                  </div>
                    ...
                    {[3, 5].map((m) => {
                      ...
                      return (
                        <button
                          ...
                          className={`relative flex items-center justify-center w-9 h-9 rounded-full border transition-colors active:scale-90 ${isActive ? 'bg-[#5F0AE3] border-[#5F0AE3] text-black' : anyActive ? 'bg-[#0B0B0E] border-[#5F0AE3]/30 text-white/30' : 'bg-[#0B0B0E] border-[#5F0AE3]/60 text-[#D2ADF8]'}`}
                        >
                          <GloveIcon className="w-5 h-5" />
                          <span className="absolute -bottom-1 -right-1 text-[8px] font-black leading-none px-1 rounded-full bg-black text-[#D2ADF8] border border-[#5F0AE3]/60">x{m}</span>
                        </button>
                      );
                    })}
                    ...
                    {(() => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center justify-center w-9 h-9 rounded-full border transition-colors active:scale-90 ${mistActive ? 'bg-[#5F0AE3] border-[#5F0AE3] text-black' : 'bg-[#0B0B0E] border-[#5F0AE3]/60 text-[#D2ADF8]'}`}
                        >
        ...
        {showViewersPanel && (
          <>
            ...
            <div className="fixed bottom-0 left-0 right-0 z-[999999] pointer-events-auto max-w-[480px] mx-auto">
              <div className="bg-[#0B0B0E]/95 backdrop-blur-md rounded-t-2xl h-[40vh] flex flex-col shadow-2xl overflow-hidden">
