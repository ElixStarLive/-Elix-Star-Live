    ...
    return (
      <div className="fixed inset-0 bg-black flex justify-center">
        <div className="relative w-full max-w-[480px] h-full bg-[#111113] flex flex-col items-center justify-center gap-4 p-6">
          <div className="w-10 h-10 border-2 border-[#6F2BFF] border-t-transparent rounded-full animate-spin" />
          ...
          <div className="flex flex-col sm:flex-row gap-2 mt-2">
            {!streamEndedReceived && (
              <button
                ...
                className="px-6 py-2.5 rounded-lg bg-[#6F2BFF]/20 border border-[#6F2BFF]/50 text-[#B57CFF] font-semibold"
              >
                Retry connection
              </button>
            )}
            <button
              ...
              className="px-6 py-2.5 rounded-lg bg-[#6F2BFF] text-black font-semibold"
            >
              Go back
            </button>
          </div>
                          ...
                          <div className="absolute inset-0 z-[1] flex flex-col items-center justify-center gap-2 bg-[#111113]">
                            {hostAvatar ? (
                              ...
                              <div className="w-16 h-16 rounded-full bg-[#111113] flex items-center justify-center">
                                <span className="text-2xl font-black text-[#B57CFF]">{(hostName || 'H').charAt(0).toUpperCase()}</span>
                              </div>
                            )}
                      ...
                      >
                        ...
                        {!hasOpponentStream && (
                          <div className="absolute inset-0 z-[1] flex flex-col items-center justify-center gap-2 bg-[#111113]">
                            {spectatorBattle.opponentName ? (
                              <div className="w-16 h-16 rounded-full bg-[#111113] flex items-center justify-center">
                                <span className="text-2xl font-black text-[#B57CFF]">{spectatorBattle.opponentName.charAt(0).toUpperCase()}</span>
                              </div>
                            ) : (
                              <div className="w-16 h-16 rounded-full bg-[#111113] flex items-center justify-center">
                                <span className="text-2xl font-black text-[#B57CFF]">O</span>
                              </div>
                            )}
                        ...
                        {lastOpponentGift && (
                          <div className="absolute bottom-1 right-1 z-20 pointer-events-none flex items-center">
                            <div className="w-5 h-5 rounded-full bg-[#111113] border border-[#6F2BFF]/40 overflow-hidden flex items-center justify-center drop-shadow-md">
                      ...
                      <div className="px-3.5 py-3 flex items-center gap-3">
                        {(opponentProfile?.avatarUrl) ? (
                          ...
                          <div className="w-10 h-10 rounded-full bg-[#111113] flex items-center justify-center flex-shrink-0">
                            <span className="text-sm font-black text-[#B57CFF]">
                        ...
                        <div className="flex gap-2 flex-shrink-0">
                          ...
                          {battleStreamIds?.opponentUserId && (
                            <button
                              type="button"
                              className="flex items-center px-3 py-2 rounded-full border border-[#6F2BFF]/40 active:scale-95 transition-transform"
                              onClick={(e) => {
                                e.stopPropagation();
                            ...
                            >
                              <span className="text-[#B57CFF] font-bold text-[11px]">Profile</span>
                            </button>
                          )}
                        </div>
                      </div>
              ...
              return (
                <>
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 bg-[#111113] z-[5]">
                      {hostAvatar ? (
                        ...
                        <div className="w-10 h-10 rounded-full bg-[#111113] flex items-center justify-center">
                          <span className="text-[#B57CFF]/60 text-sm font-bold">{hostName.slice(0, 1)}</span>
                        </div>
                      )}
                    </div>
                  )}
                  <button
                    ...
                    className="absolute top-0.5 left-0.5 z-10 rounded bg-black/55 p-0.5 border border-[#6F2BFF]/45 pointer-events-auto active:scale-95"
                  >
                ...
                <>
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 bg-[#111113] z-[5]">
                    {(viewerAvatar || user?.avatar) ? (
                      ...
                      <div className="w-10 h-10 rounded-full bg-[#111113] flex items-center justify-center">
                        <span className="text-[#B57CFF]/60 text-sm font-bold">{(viewerName || '?').charAt(0)}</span>
                      </div>
                    )}
                  </div>
                  )}
                ...
                <>
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 bg-[#111113] z-[5]">
                    {h.avatar ? (
                      ...
                      <div className="w-10 h-10 rounded-full bg-[#111113] flex items-center justify-center">
                        <span className="text-[#B57CFF]/60 text-sm font-bold">{(h.name || '?').charAt(0)}</span>
                      </div>
                    )}
              ...
              >
                ...
                {featuredLive && (
                  <>
                    ...
                    <button
                      ...
                      onClick={(e) => { e.stopPropagation(); setFeaturedUserId(null); }}
                      className="absolute top-1 left-1 z-20 flex items-center gap-0.5 px-1.5 py-0.5 rounded bg-black/60 border border-[#6F2BFF]/50 pointer-events-auto active:scale-95"
                    >
                      <ArrowLeftRight className="w-3 h-3 text-[#B57CFF]" strokeWidth={2.5} />
                ...
                {hostCamOff && !featuredLive && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 bg-[#111113] z-[5]">
                    {hostAvatar ? (
                      <img src={hostAvatar} alt="" className="w-16 h-16 rounded-full object-cover object-center border-2 border-[#6F2BFF]/40" />
                    ) : (
                      <div className="w-16 h-16 rounded-full bg-[#6F2BFF]/20 flex items-center justify-center border-2 border-[#6F2BFF]/40">
                        <span className="text-[#B57CFF] font-bold text-2xl">{hostName.slice(0, 1).toUpperCase()}</span>
                      </div>
                    )}
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center gap-4" style={{ transform: 'translateX(15mm)' }}>
                    <div className="w-24 h-24 rounded-full overflow-hidden">
                      {hostAvatar ? (
                        ...
                        <div className="w-full h-full bg-[#6F2BFF]/20 flex items-center justify-center">
                          <span className="text-[#B57CFF] font-bold text-3xl">{hostName.slice(0, 1).toUpperCase()}</span>
                        </div>
                      )}
                    </div>
                    {!user?.id ? (
                      <>
                        ...
                        <button
                          ...
                          className="mt-2 px-5 py-2.5 rounded-lg bg-[#6F2BFF] text-black font-semibold text-sm"
                        >
                          Log in
                        </button>
                      </>
                      ...
                      <>
                        <div className="flex items-center gap-2">
                          <div className="w-4 h-4 border-2 border-[#6F2BFF] border-t-transparent rounded-full animate-spin" />
                        ...
                        {showRetryButton && (
                          <button
                            ...
                            className="mt-2 px-5 py-2 rounded-lg bg-[#6F2BFF]/20 border border-[#6F2BFF]/40 text-[#B57CFF] text-sm font-medium"
                          >
                            Tap to retry
                          </button>
                        )}
...
{/* Bottom bar — above gift video so Gift/Invite/Share/More stay tappable */}
          ...
          <div className="w-full max-w-[480px] px-3 pt-0 bg-transparent">
            <div className="flex items-end gap-2 w-full max-w-[480px] pointer-events-auto">
              ...
              >
                ...
                />
                {inputValue.trim() ? (
                  <button type="submit" title="Send message" className="text-[#B57CFF] flex-shrink-0">
                    <Send size={16} />
                  </button>
                ) : null}
              </form>
              ...
              >
                <div className="relative w-10 h-10 flex items-center justify-center rounded-full bg-black/35 backdrop-blur-sm">
                  <BarChart3 size={20} className="text-[#4F7BFF] shrink-0" strokeWidth={2.2} />
                </div>
                <span className="text-[10px] font-semibold text-[#4F7BFF] mt-0.5">Poll</span>
              </button>
              ...
              >
                <div className="relative w-10 h-10 flex items-center justify-center rounded-full bg-black/35 backdrop-blur-sm">
                  <span className="flex items-center justify-center w-full h-full relative z-[2]">
                    <UserPlus size={20} className="text-[#B57CFF] shrink-0" strokeWidth={2} />
                  </span>
                </div>
                <span className="text-[10px] font-semibold text-[#B57CFF] mt-0.5">
              ...
              >
                ...
                <span className="text-[10px] font-semibold text-[#B57CFF] mt-0.5">Gift</span>
              </button>
              <button
                type="button"
                title="Share"
              ...
              >
                ...
                <span className="text-[10px] font-semibold text-[#B57CFF] mt-0.5">Share</span>
              </button>
              <button
                type="button"
                title="More options"
              ...
              >
                ...
                <span className="text-[10px] font-semibold text-[#B57CFF] mt-0.5">More</span>
              </button>
              </div>
            </div>
          </div>
        ...
        {pendingBattleInvite && (
          <div className="fixed left-0 right-0 z-[100000] pointer-events-none flex justify-center px-3" style={{ top: 'calc(env(safe-area-inset-top, 0px) + 64px)' }}>
            <div className="pointer-events-auto w-full max-w-[440px] flex items-center gap-2.5 py-1 px-2 rounded-full bg-[#111113]/95 backdrop-blur-md border border-[#6F2BFF]/40 shadow-2xl">
              <div
              ...
              >
                {pendingBattleInvite.hostAvatar ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-[#B57CFF] font-bold">{pendingBattleInvite.hostName.slice(0, 1).toUpperCase()}</div>
                )}
              </div>
              ...
              <div className="bg-[#111113]/95 backdrop-blur-md rounded-t-2xl h-[40vh] flex flex-col shadow-2xl overflow-hidden pb-safe" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex items-center justify-center px-4 py-2">
                  <div className="flex items-center gap-1.5">
                    <Crown size={14} className="text-[#B57CFF]" strokeWidth={1.8} />
                  ...
                  {pendingCoHostInvite ? (
                    <div className="w-full flex items-center gap-2.5 px-2 py-2 rounded-lg bg-white/[0.03] flex-shrink-0">
                      <div
                        ...
                        style={{ width: SHARE_PANEL_AVATAR_PX, height: SHARE_PANEL_AVATAR_PX }}
                      >
                        {pendingCoHostInvite.hostAvatar ? <img src={pendingCoHostInvite.hostAvatar} alt="" className="w-full h-full object-cover" /> : <div className="w-full h-full flex items-center justify-center text-[#B57CFF] font-bold">{pendingCoHostInvite.hostName.slice(0, 1).toUpperCase()}</div>}
                      </div>
                      <div className="flex-1 min-w-0 text-left">
                    ...
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <button
                        ...
                        onClick={() => { sendCohostJoinRequest(); }}
                        className={`w-full py-3 rounded-xl font-bold text-sm ${joinRequested ? 'bg-white/10 text-white/40 cursor-not-allowed' : 'bg-[#6F2BFF] text-black active:scale-95'}`}
                      >
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="bg-white/5 rounded-xl p-3 border border-[#6F2BFF]/20">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="bg-[#6F2BFF]/10 text-[#B57CFF] text-[7px] font-bold px-1.5 py-0.5 rounded-full border border-[#6F2BFF]/20">SUBSCRIBER ONLY</span>
                      </div>
                      <div className="grid grid-cols-4 gap-1">
                        {['🔥', '💎', '👑', '🚀', '💯', '🎉', '💖', '👀'].map((emoji, i) => (
                          <button
                            key={i}
                            className="aspect-square rounded-lg bg-white/5 hover:bg-white/10 active:scale-95 transition-all flex items-center justify-center text-sm border border-[#6F2BFF]/10 relative overflow-hidden group"
                            onClick={() => {
                              const newMessage: LiveMessage = {
                        ...
                        <button
                          className="aspect-square rounded-lg bg-white/5 hover:bg-white/10 active:scale-95 transition-all flex items-center justify-center border border-[#6F2BFF]/10 relative overflow-hidden group"
                          onClick={() => {
                            if (!isMember) return;
                        ...
                        >
                          <div className="flex flex-col items-center gap-0.5">
                            <PlusCircle size={12} className="text-[#B57CFF]/50 group-hover:text-[#B57CFF] transition-colors" />
                            <span className="text-[6px] text-[#B57CFF]/50 font-bold uppercase">Upload</span>
                          </div>
                          {!isMember && (
                            <div className="absolute inset-0 bg-[#111113]/60 backdrop-blur-[1px] flex items-center justify-center">
                              <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="#FFFFFF" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-80"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
            ...
            <div className="fixed bottom-0 left-0 right-0 pointer-events-auto max-w-[480px] mx-auto" style={{ zIndex: 99999 }}>
              {spectatorBattle?.active && (
                <div className="px-3 pb-2 pt-1 flex items-center justify-center gap-2 bg-[#111113]/95 rounded-t-xl">
                  <div className="flex rounded-full overflow-hidden border border-[#6F2BFF]/40">
                    <button
                      type="button"
                    ...
                    {[3, 5].map((m) => {
                      ...
                      return (
                        <button
                          ...
                          className={`relative flex items-center justify-center w-9 h-9 rounded-full border transition-colors active:scale-90 ${isActive ? 'bg-[#6F2BFF] border-[#6F2BFF] text-black' : anyActive ? 'bg-[#111113] border-[#6F2BFF]/30 text-white/30' : 'bg-[#111113] border-[#6F2BFF]/60 text-[#B57CFF]'}`}
                        >
                          <GloveIcon className="w-5 h-5" />
                          <span className="absolute -bottom-1 -right-1 text-[8px] font-black leading-none px-1 rounded-full bg-black text-[#B57CFF] border border-[#6F2BFF]/60">x{m}</span>
                        </button>
                      );
                    })}
                    ...
                    {(() => {
                      ...
                      return (
                        <button
                          ...
                          className={`flex items-center justify-center w-9 h-9 rounded-full border transition-colors active:scale-90 ${mistActive ? 'bg-[#6F2BFF] border-[#6F2BFF] text-black' : 'bg-[#111113] border-[#6F2BFF]/60 text-[#B57CFF]'}`}
                        >
