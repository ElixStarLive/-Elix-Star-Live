...
export function IncomingCallModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#121215]/70 backdrop-blur-md flex items-center justify-center">
      <div className="bg-[#121215] rounded-3xl p-8 max-w-sm w-full mx-4 text-center shadow-2xl">
        {remoteUser.avatar ? (
          <AvatarRing src={remoteUser.avatar} alt={remoteUser.username} size={96} className="mx-auto mb-4" />
        ) : (
          <div className="w-24 h-24 rounded-full bg-[#121215] border border-[#E5E5E7]/40 mx-auto mb-4 flex items-center justify-center text-3xl text-white">
