  ...
  return (
    <>
      ...
      {dialog && (
        ...
        >
          <div
            className="w-full max-w-[320px] bg-[#0B0B0E] rounded-2xl overflow-hidden shadow-2xl border border-white/10"
            role="alertdialog"
            aria-modal="true"
          >
            {dialog.title && (
            ...
            {dialog.type === 'prompt' && (
              <div className="px-5 pb-4">
                <input
                  ...
                  className="w-full px-3 py-2.5 bg-black/40 border border-white/20 rounded-xl text-white text-sm placeholder:text-white/30 outline-none focus:border-[#5F0AE3]/60"
                  autoFocus
                />
              </div>
            )}
            <div className="flex border-t border-white/10">
              ...
              <button
                ...
                className="flex-1 py-3.5 text-[#D2ADF8] text-sm font-bold active:bg-white/5 transition-colors"
              >
