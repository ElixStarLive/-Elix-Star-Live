    ...
    <>
      {showPollSheet && state.poll && features.poll ? (
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 z-[99999] pointer-events-auto max-w-[480px] mx-auto">
            <div
              className="bg-[#121215]/95 rounded-t-2xl p-3 pb-safe max-h-[40vh] flex flex-col shadow-2xl"
              ...
              <div className="flex-1 overflow-y-auto no-scrollbar flex flex-col gap-1.5">
                {(() => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className="absolute inset-y-0 left-0 bg-[#FF3B3F]/25"
      ...
      {showLb ? (
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 z-[99999] pointer-events-auto max-w-[480px] mx-auto">
            <div
              className="bg-[#121215]/95 rounded-t-2xl p-3 pb-safe h-[40dvh] max-h-[40dvh] flex flex-col shadow-2xl w-full overflow-hidden"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="flex justify-center mb-2">
                <div className="w-10 h-1 bg-white/20 rounded-full" />
      ...
      {(milestoneFlash || stageFlash != null) && (
        <div className="pointer-events-none fixed inset-0 z-[100] flex items-start justify-center pt-[28%] max-w-[480px] mx-auto">
          <div className="px-4 py-3 rounded-2xl bg-[#121215]/92 border border-[#E5E5E7]/50 shadow-[0_0_24px_rgba(229, 229, 231,0.35)]">
            {milestoneFlash ? (
