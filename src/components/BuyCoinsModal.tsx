          ...
          <div className="flex-1 overflow-y-auto px-4 pb-4">
            {isNative ? (
              <div className="space-y-2">
                {nativeProducts.map((product) => (
                  <button
                    ...
                    className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg bg-white/[0.03] border border-white/10 hover:bg-[#5F0AE3]/10 transition-colors active:scale-[0.98] disabled:opacity-50"
                  >
              ...
              <div className="flex flex-col items-center justify-center py-6 text-center">
                <Sparkles className="w-8 h-8 text-[#D2ADF8] mb-3" />
