              ...
              <div className="space-y-2">
                {nativeProducts.map((product) => (
                  <button
                    ...
                    className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg bg-white/[0.03] border border-white/10 hover:bg-[#D4AF37]/10 transition-colors active:scale-[0.98] disabled:opacity-50"
                  >
                    <div className="flex items-center gap-2.5">
                      <div className="w-8 h-8 rounded-full bg-[#111113] border border-[#D4AF37]/30 flex items-center justify-center">
