...
export default function AIToolsPanel({
  ...
  return (
    <div className="fixed inset-0 z-[500] flex items-end justify-center">
      ...
      <div className="relative w-full max-w-[480px] bg-[#121215] rounded-t-2xl overflow-hidden animate-in slide-in-from-bottom duration-300" style={{ maxHeight: '70dvh' }}>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-[#121215] text-white text-sm rounded-xl px-3 py-2 border border-white/10 resize-none h-20 outline-none focus:border-[#E5E5E7]/50"
                />
              </div>
              <button
                ...
                <div className="space-y-2">
                  ...
                  {captionSuggestions.map((s, i) => (
                    <button
                      ...
                      className="w-full text-left p-3 rounded-xl bg-[#121215] hover:bg-[#121215]/70 transition-colors"
                    >
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full bg-[#121215] text-white text-sm rounded-xl px-3 py-2.5 border border-white/10 outline-none appearance-none"
