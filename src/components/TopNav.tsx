...
export const TopNav = () => {
  ...
  return (
    ...
    >
      <div className="feed-column-width pointer-events-auto bg-[rgba(10,10,10,0.72)] backdrop-blur-md border-b border-[#2A2D33] min-h-[var(--topnav-bar-height)] h-[var(--topnav-bar-height)]">
