...
export const TopNav = () => {
  ...
  return (
    ...
    >
      <div className="feed-column-width pointer-events-auto bg-[rgba(0,0,0,0.35)] border-b border-[#2A2D33] min-h-[var(--topnav-bar-height)] h-[var(--topnav-bar-height)]" style={{ backdropFilter: 'blur(8px)', WebkitBackdropFilter: 'blur(8px)' }}>
