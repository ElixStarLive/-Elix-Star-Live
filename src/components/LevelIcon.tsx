...
/** Blue fundal + blue light (as instructed). */
...
export const LevelIcon: React.FC<LevelIconProps> = ({
  ...
  /** Diamond: full chip height, max width on the left — frame only, number stays beside. */
  ...
  const levelChip = (
    ...
    >
      {/* Number LEFT — not inside the diamond */}
      <span
        style={{
          color: '#FFFFFF',
          fontWeight: 900,
      ...
      {/* Diamond frame on fundal — black lines, not containing the number */}
      <img
