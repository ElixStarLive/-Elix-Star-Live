  ...
  return (
    ...
    >
      <div className="w-full max-w-[480px] mx-auto relative h-0 pointer-events-none">
        {/* Closed: thin side tab on the right edge */}
        {!open && (
          <button
            type="button"
            title="Open Daily Mission"
            aria-expanded={false}
            className="absolute pointer-events-auto flex flex-col items-center justify-center gap-1 active:scale-95 transition-transform"
            style={{
              right: '0',
              bottom: '48px',
              width: '28px',
