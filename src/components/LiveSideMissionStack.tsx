    ...
    <svg width="18" height="18" viewBox="0 0 16 16" className="flex-shrink-0 drop-shadow-[0_0_4px_rgba(255,200,80,0.65)]" aria-hidden>
      <defs>
        <linearGradient id="elixSideGift" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="100%" stopColor="#D8D9DD" />
        </linearGradient>
      </defs>
      <rect x="3" y="7" width="10" height="7" rx="1.2" fill="url(#elixSideGift)" />
      <rect x="2.5" y="5" width="11" height="2.4" rx="0.6" fill="#FFF3C4" />
      <rect x="7.2" y="5" width="1.6" height="9" fill="#E6E9EE" />
      <path d="M8 5 C6.2 3.2 4.2 4.2 4.8 5.6" stroke="#E6E9EE" strokeWidth="1.2" fill="none" />
      <path d="M8 5 C9.8 3.2 11.8 4.2 11.2 5.6" stroke="#E6E9EE" strokeWidth="1.2" fill="none" />
    </svg>
  );
}
      ...
      >
        <div className="flex items-center justify-between gap-1 w-full">
          ...
          {onOpenMissions ? (
            <button
              type="button"
              className="text-[#F5F5F7] text-[10px] font-semibold whitespace-nowrap active:opacity-80 flex-shrink-0 pl-1"
              onClick={(e) => {
                e.stopPropagation();
                onOpenMissions();
              }}
        ...
        <div className="flex items-center justify-between gap-1">
          ...
          <button
            type="button"
            className="text-[#F5F5F7] text-[10px] font-semibold whitespace-nowrap active:opacity-80"
            onClick={(e) => {
              e.stopPropagation();
              onViewAllSupporters?.();
            }}
      ...
      >
        <span
          ...
          style={{
            ...
            background: 'linear-gradient(160deg,#FFF3C4 0%,#FFD54A 45%,#D8D9DD 100%)',
        ...
        <span className="flex-1 min-w-0 flex flex-col gap-1">
          ...
          <span className="relative h-[8px] w-full rounded-full bg-black/35 overflow-hidden">
            <span
              ...
              style={{
                width: `${xpPct}%`,
                background: 'linear-gradient(90deg,#D8D9DD,#D8D9DD,#D8D9DD)',
              }}
            />
