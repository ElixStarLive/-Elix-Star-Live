...
function GiftBoxIcon() {
  return (
    <svg width="18" height="18" viewBox="0 0 16 16" className="flex-shrink-0 drop-shadow-[0_0_4px_rgba(255,200,80,0.65)]" aria-hidden>
      ...
      <rect x="7.2" y="5" width="1.6" height="9" fill="#FF3B3F" />
      <path d="M8 5 C6.2 3.2 4.2 4.2 4.8 5.6" stroke="#FF3B3F" strokeWidth="1.2" fill="none" />
      <path d="M8 5 C9.8 3.2 11.8 4.2 11.2 5.6" stroke="#FF3B3F" strokeWidth="1.2" fill="none" />
    </svg>
  );
}
      ...
      >
        <span
          ...
          style={{
            ...
            background: 'linear-gradient(160deg,#FFF3C4 0%,#FFD54A 45%,#E5E5E7 100%)',
        ...
        <span className="flex-1 min-w-0 flex flex-col gap-1">
          ...
          <span className="relative h-[8px] w-full rounded-full bg-black/35 overflow-hidden">
            <span
              ...
              style={{
                width: `${xpPct}%`,
                background: 'linear-gradient(90deg,#E5E5E7,#E5E5E7,#E5E5E7)',
              }}
            />
