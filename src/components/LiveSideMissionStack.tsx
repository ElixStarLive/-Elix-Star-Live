    ...
    <svg width="18" height="18" viewBox="0 0 16 16" className="flex-shrink-0 drop-shadow-[0_0_4px_rgba(255,200,80,0.65)]" aria-hidden>
      <defs>
        <linearGradient id="elixSideGift" x1="0" y1="0" x2="0" y2="1">
          ...
          <stop offset="100%" stopColor="#6F2BFF" />
        </linearGradient>
      </defs>
      ...
      >
        <div className="flex items-center justify-between gap-1 w-full">
          ...
          {onOpenMissions ? (
            <button
              type="button"
              className="text-[#B57CFF] text-[10px] font-semibold whitespace-nowrap active:opacity-80 flex-shrink-0 pl-1"
              onClick={(e) => {
                e.stopPropagation();
                onOpenMissions();
              }}
        ...
        <div className="flex items-center justify-between gap-1">
          ...
          <button
            type="button"
            className="text-[#B57CFF] text-[10px] font-semibold whitespace-nowrap active:opacity-80"
            onClick={(e) => {
              e.stopPropagation();
              onViewAllSupporters?.();
            }}
      ...
      >
        <span
          ...
          style={{
            ...
            background: 'linear-gradient(160deg,#FFF3C4 0%,#FFD54A 45%,#6F2BFF 100%)',
        ...
        <span className="flex-1 min-w-0 flex flex-col gap-1">
          ...
          <span className="relative h-[8px] w-full rounded-full bg-black/35 overflow-hidden">
            <span
              ...
              style={{
                width: `${xpPct}%`,
                background: 'linear-gradient(90deg,#B57CFF,#6F2BFF,#6F2BFF)',
              }}
            />
