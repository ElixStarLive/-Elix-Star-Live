    ...
    <div className="fixed inset-0 pointer-events-none z-[999996] flex justify-center">
      <div className="w-full max-w-[480px] relative">
        <div className="absolute left-0 right-0 px-1" style={{ top: 'calc(1cm + 13mm)' }}>
          {currentGift && (
            <div className="animate-slide-in-right w-full rounded-full flex items-center gap-1.5 overflow-hidden px-2 py-0.5 bg-[rgba(255,255,255,0.08)] backdrop-blur-sm">
