          ...
          {editingComment === comment.id ? (
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-1 bg-white/10 text-white px-3 py-1 rounded-lg border border-white/20 focus:border-[#6F2BFF] outline-none"
          ...
          {replyingTo?.id === comment.id && (
            <div className="mt-3 flex gap-2">
              <input
                ...
                className="flex-1 bg-white/10 text-white px-3 py-2 rounded-lg border border-white/20 focus:border-[#6F2BFF] outline-none"
                autoFocus
              />
              <button
