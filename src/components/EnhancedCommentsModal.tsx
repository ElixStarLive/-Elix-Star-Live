...
export default function CommentsModal({ isOpen, onClose, videoId }: CommentsModalProps) {
          ...
          {editingComment === comment.id ? (
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-1 bg-white/10 text-white px-3 py-1 rounded-lg border border-white/20 focus:border-[#E5E5E7] outline-none"
          ...
          {replyingTo?.id === comment.id && (
            <div className="mt-3 flex gap-2">
              <input
                ...
                className="flex-1 bg-white/10 text-white px-3 py-2 rounded-lg border border-white/20 focus:border-[#E5E5E7] outline-none"
                autoFocus
              />
              <button
  ...
  return (
    ...
    >
      <div
        className="bg-[#121215]/95 rounded-t-2xl p-3 pb-safe h-1/2 w-full max-w-[480px] shadow-2xl flex flex-col bottom-sheet-above-nav"
          ...
          <div className="flex gap-2 items-center">
            ...
            <div className="flex-1 flex gap-2">
              <input
                ...
                className="flex-1 bg-[#121215] text-white px-3 py-2 rounded-lg border border-white/10 focus:border-secondary outline-none text-sm"
                onKeyDown={(e) => {
