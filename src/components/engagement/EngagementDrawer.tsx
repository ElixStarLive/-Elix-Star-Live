          ...
          return (
            <div key={m.id} className="rounded-xl border border-white/10 bg-white/[0.03] p-2.5">
              <div className="flex items-start justify-between gap-2 mb-1">
                ...
                {m.completed && !m.claimed ? (
                  <button
                    ...
                    className="shrink-0 rounded-lg bg-[#E6E9EE]/25 border border-[#D8D9DD]/50 px-2 py-1 text-[10px] font-bold text-[#F5F5F7]"
                  >
                    Claim
                  </button>
                ) : m.claimed ? (
              ...
              <div className="h-1.5 rounded-full bg-white/10 overflow-hidden mb-1">
                <div className="h-full bg-[#E6E9EE]" style={{ width: `${pct}%` }} />
              </div>
      ...
      <div className="flex flex-col gap-1.5">
        {tiers.map((t) => {
          ...
          return (
            ...
            >
              <span className={`text-sm ${active ? "text-[#F5F5F7]" : "text-white/50"}`}>
                {t.name}
              </span>
        ...
        <div className="flex flex-col gap-1.5">
          {rows.map((r) => {
            ...
            return (
              ...
              >
                <span className="w-7 text-sm font-bold text-[#F5F5F7] tabular-nums">
                  #{r.rank}
                </span>
            ...
            return (
              <div
                ...
                className={`aspect-square rounded-lg flex items-center justify-center text-[10px] font-bold border ${
                    ...
                    ? "bg-[#E6E9EE]/30 border-[#D8D9DD]/50 text-[#F5F5F7]"
                    : current
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <button
                    ...
                    className="shrink-0 rounded-lg bg-[#E6E9EE]/25 border border-[#D8D9DD]/50 px-2.5 py-1 text-[11px] font-bold text-[#F5F5F7]"
                  >
                    Open
                  </button>
                </div>
      ...
      {sets.map((s) => (
        <div key={s.id} className="rounded-xl border border-white/10 bg-white/[0.03] p-2.5 mb-2">
          <div className="flex justify-between gap-2 mb-1">
            ...
            <span className="text-[11px] tabular-nums text-[#F5F5F7]">
              {s.progress}/{s.total}
              {s.complete ? " ✓" : ""}
            </span>
          </div>
