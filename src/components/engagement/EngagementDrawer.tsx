...
function HubBody({ onSelect }: { onSelect: (id: EngagementPanel) => void }) {
  ...
  return (
    <>
      <div className="rounded-2xl border border-[#6F2BFF]/30 bg-gradient-to-br from-[#1a1608] to-[#111113] p-3 mb-3">
        <p className="text-[10px] uppercase tracking-wide text-[#B57CFF] mb-1">
          ...
          return (
            <div key={m.id} className="rounded-xl border border-white/10 bg-white/[0.03] p-2.5">
              <div className="flex items-start justify-between gap-2 mb-1">
                ...
                {m.completed && !m.claimed ? (
                  <button
                    ...
                    className="shrink-0 rounded-lg bg-[#6F2BFF]/25 border border-[#6F2BFF]/50 px-2 py-1 text-[10px] font-bold text-[#B57CFF]"
                  >
                    Claim
                  </button>
                ) : m.claimed ? (
              ...
              <div className="h-1.5 rounded-full bg-white/10 overflow-hidden mb-1">
                <div className="h-full bg-[#6F2BFF]" style={{ width: `${pct}%` }} />
              </div>
...
function FanLevelBody() {
  ...
  return (
    <>
      <div className="rounded-2xl border border-[#6F2BFF]/30 bg-gradient-to-br from-[#1a1608] to-[#111113] p-3 mb-3">
        <p className="text-[10px] text-[#B57CFF] uppercase tracking-wide mb-1">
          {fan?.tier || "Bronze Fan"}
        </p>
      ...
      <div className="flex flex-col gap-1.5">
        {tiers.map((t) => {
          ...
          return (
            ...
            >
              <span className={`text-sm ${active ? "text-[#B57CFF]" : "text-white/50"}`}>
                {t.name}
              </span>
        ...
        {(
          ...
          <button
            ...
            className={`rounded-full px-2.5 py-1 text-[11px] font-semibold border ${
              period === id
                ? "border-[#6F2BFF] bg-[#6F2BFF]/20 text-[#B57CFF]"
        ...
        <div className="flex flex-col gap-1.5">
          {rows.map((r) => {
            ...
            return (
              ...
              >
                <span className="w-7 text-sm font-bold text-[#B57CFF] tabular-nums">
                  #{r.rank}
                </span>
...
function BattleEnergyBody({ roomId }: { roomId: string }) {
  ...
  return (
    <>
      <div className="rounded-2xl border border-[#6F2BFF]/30 bg-gradient-to-br from-[#1a1608] to-[#111113] p-3 mb-3">
        <p className="text-[10px] text-[#B57CFF] uppercase tracking-wide mb-1 flex items-center gap-1">
      ...
      <div className="flex gap-2 mb-3">
        {[100, 500, 1000].map((n) => (
          <button
            ...
            className="flex-1 rounded-xl border border-[#6F2BFF]/40 bg-[#6F2BFF]/10 py-2 text-sm font-bold text-[#B57CFF] active:scale-95 disabled:opacity-40"
          >
            +{n}
          </button>
        ))}
      ...
      <button
        ...
        className="w-full rounded-xl border border-[#6F2BFF]/50 bg-[#6F2BFF]/20 py-2.5 text-sm font-semibold text-[#B57CFF] disabled:opacity-40"
      >
        BOOST CREATOR
      </button>
      {lastBoost ? (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  <button
                    ...
                    className="shrink-0 rounded-lg bg-[#6F2BFF]/25 border border-[#6F2BFF]/50 px-2.5 py-1 text-[11px] font-bold text-[#B57CFF]"
                  >
                    Open
                  </button>
                </div>
      ...
      {sets.map((s) => (
        <div key={s.id} className="rounded-xl border border-white/10 bg-white/[0.03] p-2.5 mb-2">
          <div className="flex justify-between gap-2 mb-1">
            ...
            <span className="text-[11px] tabular-nums text-[#B57CFF]">
              {s.progress}/{s.total}
              {s.complete ? " ✓" : ""}
            </span>
          </div>
          ...
          return (
            ...
            >
              <div className="flex justify-between gap-2 mb-0.5">
                ...
                <span className="text-[11px] text-[#B57CFF]">
