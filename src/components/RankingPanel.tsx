...
export function RankingPanel({
  ...
  return (
    <div
      className="bg-[#0B0B0E]/95 backdrop-blur-md rounded-t-2xl p-3 pb-safe max-h-[40dvh] flex flex-col shadow-2xl w-full overflow-hidden h-full"
      ...
      <div className="flex justify-between items-center mb-2 flex-shrink-0">
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-full bg-[#0B0B0E] flex items-center justify-center border border-[#5F0AE3]/40">
            <HeaderIcon className="w-4 h-4 text-[#D2ADF8]" fill="currentColor" />
          </div>
          <div>
              ...
              <div className="bg-white/5 rounded-xl p-3 border border-[#5F0AE3]/20">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[#D2ADF8] text-[10px] font-bold tabular-nums">
                      {giftGoal.currentCount}/{giftGoal.targetCount} points
                    </p>
                  </div>
                  {isGiftGoalComplete(giftGoal) ? (
                    <span className="text-[9px] font-bold text-black bg-[#5F0AE3] px-2 py-1 rounded-full">Done</span>
                  ) : null}
                </div>
                ...
                {onSendGiftGoal && !isGiftGoalComplete(giftGoal) ? (
                  <button
                    ...
                    className="w-full py-2 bg-gradient-to-r from-[#D2ADF8] to-[#D2ADF8] text-black font-bold text-[10px] uppercase tracking-wide rounded-xl active:scale-[0.98]"
                  >
        ...
        {rankings[0] && (
          <div className="flex flex-col items-center gap-1 w-1/3 order-2 -mt-4 z-10">
            <div className="relative">
              ...
              <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-[#5F0AE3] text-black text-xs font-black px-2 py-0.5 rounded-full border border-white">
                1
              </div>
            </div>
