...
> = {
  top_gifter: {
    label: 'Top Gifter',
    chip: 'bg-[#6F2BFF] text-black',
    glow: 'border-[#6F2BFF]/50 shadow-[0_0_10px_rgba(111, 43, 255,0.45)]',
  },
  vip: {
    label: 'VIP',
    chip: 'bg-[#4F7BFF] text-white',
    glow: 'border-[#4F7BFF]/45 shadow-[0_0_10px_rgba(79, 123, 255,0.35)]',
  },
  elite: {
    label: 'Elite',
