    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between gap-2 px-4 pb-0.5 flex-shrink-0">
          <h3 className="text-[#B57CFF] font-bold whitespace-nowrap text-sm">Share to</h3>
          <div className="flex-none w-[120px] bg-white/5 rounded-lg px-2 py-0.5 flex items-center gap-2 border border-[#6F2BFF]/35">
            <Search className="w-3.5 h-3.5 text-[#B57CFF]" />
            <input
              value={shareQuery}
              onChange={(e) => setShareQuery(e.target.value)}
              placeholder="Search..."
              className="bg-transparent text-[#B57CFF]/90 text-xs outline-none w-full placeholder:text-[#B57CFF]/45"
            />
          </div>
        </div>
