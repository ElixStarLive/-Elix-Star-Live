    ...
    >
      {iconSrc ? (
        ...
        <Icon 
          ...
          style={isActive && !iconSrc ? { fill: '#5F0AE3' } : { fill: 'transparent' }}
        />
      )}
    </button>
    {label && (
...
export default function EnhancedVideoPlayer({ 
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute inset-0 flex items-center justify-center bg-[#0B0B0E]"
        style={{ margin: 0, padding: 0, gap: 0 }}
      >
        ...
        {videoError && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#0B0B0E] z-10 gap-3">
            <span className="text-white/50 text-sm">Video processing...</span>
            <button
              type="button"
              onClick={retryVideoPlayback}
              className="px-4 py-1.5 bg-[#5F0AE3]/20 border border-[#5F0AE3]/40 rounded-lg text-[#D2ADF8] text-xs font-medium"
            >
              Tap to retry
            </button>
          </div>
        ...
        >
          ...
          >
            <div
              className="h-full rounded-full bg-gradient-to-r from-[#D2ADF8] via-[#00c2be] to-[#D2ADF8] relative overflow-hidden"
              style={{
      ...
      />
        ...
        <div className="fixed inset-0 z-modals flex items-end justify-center">
          ...
          <div
            className="bg-[#0B0B0E]/95 rounded-t-2xl max-h-[40dvh] flex flex-col shadow-2xl pointer-events-auto w-full max-w-[480px] relative z-10 bottom-sheet-above-nav"
          ...
          >
            <div className="flex items-center justify-between px-4 py-3 border-b border-white/10">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#D2ADF8] font-bold text-sm">More Options</span>
              </div>
            </div>
            <div className="p-4 overflow-y-auto overflow-x-hidden min-h-0 flex-1">
              {showQrCodeInMore && (
                <div className="mb-3 p-3 rounded-xl bg-white/5 border border-white/10 flex flex-col items-center gap-2">
                  ...
                  />
                  <button type="button" onClick={() => setShowQrCodeInMore(false)} className="text-[#D2ADF8] text-xs font-semibold">Close</button>
                </div>
              )}
              <div className="grid grid-cols-4 gap-y-4 gap-x-2">
                ...
                >
                  ...
                  <span className="text-[10px] font-semibold text-[#D2ADF8]">Copy Link</span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="text-[10px] font-semibold text-[#D2ADF8]">Download</span>
                </button>
                <button
                  type="button"
                  onClick={moreDuet}
                ...
                >
                  ...
                  <span className="text-[10px] font-semibold text-[#D2ADF8]">Duet</span>
                </button>
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="text-[10px] font-semibold text-[#D2ADF8]">QR Code</span>
                </button>
                {isOwnVideo && (
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <span className="text-[10px] font-semibold text-[#D2ADF8]">Delete video</span>
                  </button>
                )}
                <button
                  type="button"
                ...
                >
                  ...
                  <span className="text-[10px] font-semibold text-[#D2ADF8]">Share</span>
                </button>
                <button
                  type="button"
                  onClick={moreSave}
                ...
                >
                  ...
                  <span className="text-[10px] font-semibold text-[#D2ADF8]">{video.isSaved ? 'Unsave' : 'Save'}</span>
                </button>
                <button
                  type="button"
                  onClick={moreFollow}
                ...
                >
                  ...
                  <span className="text-[10px] font-semibold text-[#D2ADF8]">{video.isFollowing ? 'Unfollow' : 'Follow'}</span>
                </button>
                <button
                  type="button"
                  onClick={morePromote}
                ...
                >
                  ...
                  <span className="text-[10px] font-semibold text-[#D2ADF8]">Promote</span>
                </button>
                <button
                  type="button"
                  onClick={moreReport}
                ...
                >
                  ...
                  <span className="text-[10px] font-semibold text-[#D2ADF8]">Report</span>
                </button>
              </div>
            </div>
          </div>
