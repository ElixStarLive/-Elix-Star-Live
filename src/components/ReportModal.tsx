          ...
          {reportReasons.map((reason) => {
            ...
            return (
              <button
                ...
                className={`w-full px-3 py-2 flex items-center justify-between rounded-lg transition-colors ${selected ? 'bg-[#D4AF37]/10' : 'hover:bg-white/[0.03]'}`}
              >
                ...
                <div className={`w-4 h-4 rounded-full border flex items-center justify-center flex-shrink-0 ${selected ? 'border-[#D4AF37] bg-[#D4AF37]' : 'border-white/20'}`}>
                  {selected && (
