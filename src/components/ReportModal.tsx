...
export default function ReportModal({ isOpen, onClose, videoId, contentType, contentId }: ReportModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-end justify-center">
      ...
      <div className="relative w-full feed-column-width z-10 elix-panel backdrop-blur-md rounded-t-2xl p-4 pb-safe flex flex-col gap-1 pointer-events-auto h-[40vh] max-h-[40vh] overflow-y-auto bottom-sheet-above-nav [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-white/5 [&::-webkit-scrollbar-thumb]:bg-[#E6E9EE]/50 [&::-webkit-scrollbar-thumb]:rounded-full" style={{ scrollbarWidth: 'thin', scrollbarColor: 'rgba(255,255,255,0.25) transparent' }}>
