...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[100dvh] bg-[#121215] text-white flex items-center justify-center px-4">
          <div className="max-w-md text-center">
            ...
            <div className="flex gap-3 justify-center">
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-[#FF3B3F] text-black rounded-full font-bold hover:opacity-90 transition"
              >
