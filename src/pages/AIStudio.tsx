...
export default function AIStudio() {
  ...
  return (
    <div className="h-full min-h-0 w-full bg-[rgba(0,0,0,0.35)] text-white flex flex-col overflow-hidden">
      {toast && (
      ...
      <div className="flex-1 relative bg-transparent flex items-center justify-center overflow-hidden">
        {videoUrl ? (
          ...
          <div className="flex flex-col items-center gap-4 p-8">
            <div className="w-24 h-24 rounded-2xl bg-[rgba(0,0,0,0.35)] flex items-center justify-center">
