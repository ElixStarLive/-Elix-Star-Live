...
export default function EditProfile() {
  ...
  return (
    <SettingsOptionSheet onClose={goBack}>
      ...
      {/* Header */}
      <div className="flex-shrink-0 px-4 py-3 flex items-center justify-between bg-[#121215]">
        <button
          onClick={handleSave}
          disabled={loading}
          className="px-4 py-1.5 rounded-full bg-[#FF3B3F] text-black text-sm font-semibold disabled:opacity-50 hover:brightness-110 transition"
        >
          {loading ? 'Saving...' : 'Save'}
        </button>
        ...
        <div className="flex flex-col items-center gap-2 flex-shrink-0">
          <div className="relative group cursor-pointer">
            ...
            <label
              ...
              className="absolute bottom-0 right-0 w-8 h-8 bg-[#FF3B3F] rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition shadow-lg"
            >
  ...
  return (
    <div>
      ...
      <input
        ...
        maxLength={maxLength}
        className="w-full bg-white/[0.06] rounded-lg px-3 py-2.5 outline-none text-sm leading-tight text-gold-bright placeholder:text-gold-bright/35 border border-white/10 focus:border-[#E5E5E7]/50 focus:outline-none transition"
      />
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <textarea
        ...
        maxLength={maxLength}
        rows={3}
        className="w-full bg-white/[0.06] rounded-lg px-3 py-2.5 outline-none text-sm leading-relaxed text-gold-bright placeholder:text-gold-bright/35 border border-white/10 focus:border-[#E5E5E7]/50 focus:outline-none transition resize-none"
      />
      {maxLength && (
