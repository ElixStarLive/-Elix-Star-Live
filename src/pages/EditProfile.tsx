...
export default function EditProfile() {
  ...
  return (
    <SettingsOptionSheet onClose={goBack}>
      ...
      {/* Header */}
      <div className="flex-shrink-0 px-4 py-3 flex items-center justify-between bg-[rgba(0,0,0,0.35)]">
        <button
          onClick={handleSave}
          disabled={loading}
          className="px-4 py-1.5 rounded-full bg-[#F0C86B] text-white text-sm font-semibold disabled:opacity-50 hover:brightness-110 transition"
        >
          {loading ? 'Saving...' : 'Save'}
        </button>
        ...
        <div className="flex flex-col items-center gap-2 flex-shrink-0">
          <div className="relative group cursor-pointer">
            ...
            <label
              ...
              className="absolute bottom-0 right-0 w-8 h-8 bg-[#F0C86B] rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition shadow-lg"
            >
