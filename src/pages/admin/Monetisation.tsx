      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <section className="space-y-3">
          ...
          <button
            ...
            className="px-3 py-2 rounded-lg bg-[#F0C86B] text-white elix-accent text-sm font-bold"
          >
            Import report
          </button>
        </section>
            ...
            {fraudReviews.length === 0 ? (
              ...
              fraudReviews.map((fr) => (
                ...
                >
                  ...
                  <button
                    type="button"
                    className="px-2 py-1 rounded bg-[#F0C86B] text-white elix-accent font-bold"
  ...
  return (
    <label className="block bg-white/5 border border-white/10 rounded-lg p-3">
      ...
      <div className="flex gap-2 mt-1">
        ...
        <button
          type="button"
          className="px-2 py-1 rounded bg-[#F0C86B] text-white elix-accent text-xs font-bold"
...
function Toggle({
  ...
  return (
    <button
      type="button"
      onClick={onToggle}
      className={`px-3 py-2 rounded-lg text-xs font-bold ${on ? 'bg-[#F0C86B] text-white elix-accent' : 'bg-white/10 text-white'}`}
    >
      {label}: {on ? 'ON' : 'OFF'}
    </button>
  );
