    ...
    <div className="min-h-screen bg-[#0B0B0E] text-white p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="bg-[#0B0B0E] rounded-lg overflow-hidden">
            {packages.length === 0 ? (
                  ...
                  <tr key={gift.id} className="hover:bg-[#2A2D35]/50">
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`px-2 py-1 rounded text-xs ${
                          gift.is_active ? 'bg-[#5F0AE3]' : 'bg-[#2A2D35]'
                        }`}
                      >
                    ...
                    <td className="px-4 py-3 text-right">
                      <button
                        ...
                        className="px-3 py-1 bg-[#5F0AE3] text-black rounded hover:bg-[#5F0AE3]/90 text-sm"
                      >
                        Edit Price
                      </button>
                    </td>
                ...
                {boosters.map(booster => (
                  <tr key={booster.id} className="hover:bg-[#2A2D35]/50">
                    ...
                    <td className="px-4 py-3">
                      <span
                        className={`px-2 py-1 rounded text-xs ${
                          booster.is_active ? 'bg-[#5F0AE3]' : 'bg-[#2A2D35]'
                        }`}
                      >
