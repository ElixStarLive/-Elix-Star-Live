            ...
            <div className="p-4 rounded-2xl bg-transparent flex gap-4 w-full">
              ...
              <div className="flex-1 min-w-0">
                ...
                <button
                  ...
                  className="bg-[#E6E9EE] text-white elix-accent px-6 py-1.5 rounded-full font-semibold flex items-center gap-1.5 text-sm w-fit active:scale-95 transition-transform disabled:opacity-50"
                >
                  <Bookmark
                    size={12}
          ...
          {!songId ? (
            <>
              <div className="px-3 pb-2">
                <div className="flex items-center gap-2 px-3 py-2 rounded-full border border-[#D8D9DD]/25 bg-transparent">
            ...
            <div className="grid grid-cols-3 gap-0.5 w-full">
              {videosLoading ? (
                ...
                videos.map((video) => (
                  <div
                    key={video.id}
                    className="aspect-[3/4] bg-transparent relative cursor-pointer"
