...
export default function Legal() {
  ...
  return (
    <div className="bg-transparent text-white flex justify-center px-2">
      <div className="w-full max-w-[480px] rounded-3xl overflow-hidden bg-transparent flex flex-col overflow-y-auto p-4">
        ...
        <div className="space-y-1">
          {items.map((item) => (
            <button
              key={item.label}
              type="button"
              className="w-full flex items-center p-4 hover:bg-transparent cursor-pointer text-left"
