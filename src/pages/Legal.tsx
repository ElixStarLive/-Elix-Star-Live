...
export default function Legal() {
  ...
  return (
    <div className="bg-[rgba(0,0,0,0.35)] text-white flex justify-center px-2">
      <div className="w-full max-w-[480px] rounded-3xl overflow-hidden bg-[rgba(0,0,0,0.35)] flex flex-col overflow-y-auto p-4">
        ...
        <div className="space-y-1">
          {items.map((item) => (
            <button
              key={item.label}
              type="button"
              className="w-full flex items-center p-4 hover:bg-[rgba(0,0,0,0.35)] cursor-pointer text-left"
