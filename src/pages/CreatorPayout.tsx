...
export default function CreatorPayout() {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[rgba(0,0,0,0.35)] flex flex-col max-w-[480px] mx-auto">
          ...
          <>
            ...
            <div className="rounded-xl border border-[#D8D9DD]/25 bg-white/5 p-3 space-y-2">
              ...
              <button
                ...
                className="w-full py-2.5 rounded-lg bg-[#F0C86B] text-white elix-accent text-[12px] font-bold disabled:opacity-50"
              >
            ...
            <div className="rounded-xl border border-[#D8D9DD]/25 bg-white/5 p-3 space-y-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg text-[11px] font-bold ${methodType === 'bank' ? 'bg-[#F0C86B] text-white elix-accent' : 'bg-white/10 text-white'}`}
                >
                  Bank
                </button>
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg text-[11px] font-bold ${methodType === 'paypal' ? 'bg-[#F0C86B] text-white elix-accent' : 'bg-white/10 text-white'}`}
                >
                  PayPal
                </button>
              </div>
