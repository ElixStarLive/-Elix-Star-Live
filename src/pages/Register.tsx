...
export default function Register() {
  ...
  return (
    <div className="min-h-[100dvh] h-[100dvh] bg-[rgba(0,0,0,0.35)] text-white flex items-center justify-center p-4 xs:p-3 sm:p-4 overflow-y-auto pt-[calc(var(--safe-top)+46px)] pb-[calc(var(--safe-bottom)+var(--nav-height))]">
