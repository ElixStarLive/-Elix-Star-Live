...
export default function Report() {
  ...
  return (
    <SettingsOptionSheet onClose={goBack}>
      <div className="w-full h-full min-h-0 flex flex-col overflow-hidden bg-[#0B0B0E]">
      <div className="sticky top-0 bg-[#0B0B0E] z-10 px-4 py-4 border-b border-transparent flex items-center justify-center">
      ...
      <div className="px-4 py-6 flex-1 overflow-y-auto">
            ...
            <button
              ...
              className={`w-full text-left px-4 py-4 rounded-xl transition ${
                selectedReason === reason.id
                  ? 'bg-[#5F0AE3]/20 border-2 border-[#5F0AE3]'
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            maxLength={500}
            rows={4}
            className="w-full bg-white rounded-xl px-4 py-3 outline-none text-white placeholder-white/40 border border-transparent focus:border-[#5F0AE3] transition resize-none"
          />
