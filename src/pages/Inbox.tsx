  ...
  return (
    <div className="page-above-bottom-nav bg-[#09090B]">
      <div className="page-above-bottom-nav__inner bg-[#09090B] flex flex-col min-h-0">
        ...
        <div className="px-3 pb-2 bg-[#09090B]" style={{ marginTop: '4mm' }}>
        ...
        <div className="pl-[calc(1rem+22mm)] pr-4 py-2 flex items-center justify-center gap-3 overflow-x-auto no-scrollbar mb-2 bg-[#09090B]" style={{ marginLeft: '-20mm' }}>
        ...
        <div className="px-4 py-1 space-y-4 bg-[#09090B] pb-4">
            ...
            <button
                type="button"
                onClick={openNewFollowersPanel}
                className="flex items-center gap-3 w-full text-left py-2 px-2 bg-[#09090B]"
            >
            ...
            <button onClick={filterActivity} className="flex items-center gap-3 w-full text-left py-2 px-2 bg-[#09090B]">
                <div className="relative w-12 h-12 rounded-full flex items-center justify-center overflow-hidden flex-shrink-0 royce-tile">
                ...
                {activityItems.slice(0, 5).map((a) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex items-center gap-2.5 w-full text-left py-1.5 px-2 bg-[#09090B]"
                    >
                      <div className="w-9 h-9 rounded-full bg-[#09090B] border border-[#D8D9DD]/30 flex items-center justify-center flex-shrink-0 overflow-hidden relative" style={{ transform: 'translateY(4mm)' }}>
                        {a.actor_avatar_url ? (
            ...
            <div className="space-y-1 pt-2">
                ...
                {conversations.length === 0 ? (
                    ...
                    conversations.map((conv) => (
                        <div key={conv.id} className="flex items-center gap-3 py-2 px-2 bg-[#09090B] group">
                            ...
                            <button
                                ...
                                className="w-10 h-10 rounded-full bg-[#09090B] border border-[#D8D9DD]/40 flex items-center justify-center flex-shrink-0 active:scale-95 transition-transform hover:border-[#D8D9DD]/50 hover:bg-[#09090B]"
                    ...
                    liveShareRequests.map((row) => {
                      ...
                      return (
                        <button
                          ...
                          className="flex items-center gap-3 w-full text-left py-2.5 px-2 bg-[#09090B]"
                        >
                          <div className="w-12 h-12 rounded-full bg-[#09090B] border border-[#D8D9DD]/40 flex items-center justify-center flex-shrink-0 overflow-hidden relative">
                            {row.sharer_avatar ? (
                            ...
                            <span className="absolute bottom-0 right-0 w-5 h-5 rounded-full bg-[#09090B] border border-[#D8D9DD]/50 flex items-center justify-center">
                    ...
                    {activityItems.map((a) => {
                      ...
                      return (
                        <button
                          ...
                          className="flex items-center gap-3 w-full text-left py-2.5 px-2 bg-[#09090B]"
                        >
                          <div className="w-12 h-12 rounded-full bg-[#09090B] border border-[#D8D9DD]/40 flex items-center justify-center flex-shrink-0 overflow-hidden relative" style={{ transform: 'translateY(4mm)' }}>
                            {a.actor_avatar_url ? (
                              <img src={a.actor_avatar_url} alt="" className="w-full h-full object-cover" />
                            ) : (
                        ...
                        .map((notif) => {
                          ...
                          return (
                            <button
                              ...
                              className="flex items-center gap-3 w-full text-left py-2.5 px-2 bg-[#09090B]"
                            >
                              <div className="w-12 h-12 rounded-full bg-[#09090B] border border-[#D8D9DD]/40 flex items-center justify-center flex-shrink-0 overflow-hidden">
            ...
            {(activeFilter === 'main') && notifications
                ...
                <button key={notif.id} onClick={() => { if (notif.action_url) openActionUrl(notif.action_url); }} className="flex items-center gap-3 w-full text-left py-2 px-2">
                    {liveNotif ? (
                      ...
                      <div className="w-12 h-12 rounded-full bg-[#09090B] border border-[#D8D9DD]/40 flex items-center justify-center flex-shrink-0">
             ...
             {activeFilter === 'main' && notifications.filter(n => n.type === 'shop').map(notif => (
                <button key={notif.id} onClick={goShop} className="flex items-center gap-3 w-full text-left">
                    <div className="w-12 h-12 rounded-full bg-[#09090B] border border-[#D8D9DD]/40 flex items-center justify-center">
        ...
        <div className="page-above-bottom-nav bg-[#09090B] z-[101] pointer-events-auto">
          <div className="page-above-bottom-nav__inner bg-[#09090B] flex flex-col min-h-0">
            <div className="flex-1 min-h-0 overflow-y-auto bg-[#09090B] new-followers-panel-scroll">
              ...
              <div className="space-y-0.5 pb-4 px-4 bg-[#09090B]">
                {myNewFollowers.map((f) => (
                    <div
                      key={f.user_id}
                      className="flex items-center gap-2 w-full py-2.5 px-0 bg-[#09090B]"
                    >
                      <button
                        type="button"
                        className="flex items-center gap-3 flex-1 min-w-0 text-left bg-[#09090B]"
                        onClick={() => openFollowerProfile(f.user_id)}
                      >
                        <div className="relative w-11 h-11 rounded-full bg-[#09090B] flex items-center justify-center overflow-hidden flex-shrink-0">
                          {f.avatar_url ? (
                      ...
                      <button
                        type="button"
                        className="p-1 flex-shrink-0 bg-[#09090B]"
                        onClick={() => openFollowerProfile(f.user_id)}
