                     ...
                     {isPosting ? (
                       <div className="w-full max-w-md px-1">
                         ...
                         <div className="h-1.5 bg-white/20 rounded-full overflow-hidden">
                           <div className="h-full bg-[#F0C86B] elix-progress-fill" style={{ width: `${postProgress}%` }} />
                         </div>
                       </div>
                     ) : null}
                   ...
                   <div className="flex items-center justify-between gap-2 pl-0.5">
                     ...
                     <button
                       ...
                       className={`w-8 h-4 rounded-full transition-colors shrink-0 ${
                         postWithoutAudio ? 'bg-[#F0C86B]' : 'bg-white/20'
                       }`}
                       onClick={() => {
              ...
              {cameraError && (
                <div className="absolute inset-0 flex flex-col items-center justify-center z-[5] bg-[rgba(0,0,0,0.35)] text-white p-6 text-center">
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 rounded-full bg-[#F0C86B] text-white elix-accent text-sm font-semibold active:scale-95 transition-transform pointer-events-auto"
                  >
                    Try Again
                  </button>
                </div>
