          ...
          <div className="flex w-12 shrink-0 items-center justify-start">
            {otherUser && (
              <button
                ...
                className="p-2 rounded-full bg-[#111113] border border-[#D4AF37]/40 hover:bg-[#D4AF37]/10 transition-colors"
          ...
          {messages.map((m) => {
            ...
            return (
              <div key={m.id} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                <div className={`max-w-[80%] rounded-2xl px-4 py-2 text-sm leading-snug break-words ${isMe ? 'bg-[#D4AF37] text-black rounded-tr-none' : 'bg-[#202024] text-white rounded-tl-none'}`}>
