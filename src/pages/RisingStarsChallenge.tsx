      ...
      <div className="page-above-bottom-nav__inner">
        ...
        >
          ...
          >
            ...
            <button type="button" onClick={() => void share()} className="text-xs text-[#D4AF37]">
              Share
            </button>
          </div>
        </div>
          ...
          {loading || !challenge ? (
            ...
            <>
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4 mb-4">
                <div className="text-xs text-[#D4AF37] mb-1 uppercase">
              ...
              {user && ["open", "voting"].includes(challenge.status) && (
                <div className="rounded-2xl border border-[#D4AF37]/25 bg-[#1a1608] p-4 mb-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      onClick={() => void enter()}
                      className="flex-1 py-2 rounded-xl bg-[#D4AF37] text-black text-xs font-semibold disabled:opacity-40"
                    >
                      Submit entry
                    </button>
                  </div>
              ...
              <h3 className="text-sm font-semibold mb-2 flex items-center gap-2">
                <Vote className="w-4 h-4 text-[#D4AF37]" /> Entries
                {votedToday && (
              ...
              <div className="space-y-2">
                {entries.length === 0 ? (
                  ...
                  entries.map((e, idx) => (
                    ...
                    >
                      <span className="w-6 text-center text-[#D4AF37] font-bold text-sm">
                        {idx + 1}
                      </span>
                      <button
                        type="button"
