...
export default function Hashtag() {
  ...
  return (
    <div className="h-full min-h-0 w-full bg-[#111113] text-white flex justify-center px-2">
      ...
      {/* Header */}
      <div className="sticky top-0 z-10 px-4 py-6 bg-[#111113]">
        <div className="flex items-center gap-3 mb-4">
          <button onClick={goFeed} className="p-1 hover:brightness-125 transition" title="Back to For You">
            <RoyceBackIcon />
          </button>
          <div className="w-16 h-16 bg-gradient-to-br from-[#8B3DFF] to-[#6F2BFF] rounded-full flex items-center justify-center">
          ...
          <div className="grid grid-cols-3 gap-1">
            {videos.map(video => (
              <button
                ...
                className="relative aspect-[9/16] bg-[#111113] rounded overflow-hidden text-left"
              >
                <img
