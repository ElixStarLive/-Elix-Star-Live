        ...
        {!(remoteHasVideo && status === 'connected') && (
          <div className="w-full h-full flex flex-col items-center justify-center gap-4">
            {remoteUser.avatar ? (
              ...
              <div className="w-24 h-24 rounded-full bg-[#111113] border border-[#D4AF37]/40 flex items-center justify-center text-3xl text-white">
      ...
      <div className="w-full bg-[#111113]/80 backdrop-blur-sm pb-10 pt-6 px-6 shrink-0">
        <div className="flex items-center justify-center gap-6">
          ...
          <button
            ...
            title="Switch camera"
            className="w-14 h-14 rounded-full bg-[#111113] border border-[#D4AF37]/40 flex items-center justify-center"
          >
