...
export default function VideoCall() {
  ...
  if (!callId || !remoteUser) {
    return (
      <div className="min-h-[100dvh] h-[100dvh] w-full bg-[#121215] flex justify-center text-white overflow-hidden">
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col bg-[#121215] pb-[var(--bottom-ui-reserve)]">
      ...
      <div className="flex-1 min-h-0 relative w-full">
        ...
        {!(remoteHasVideo && status === 'connected') && (
          <div className="w-full h-full flex flex-col items-center justify-center gap-4">
            {remoteUser.avatar ? (
              ...
              <div className="w-24 h-24 rounded-full bg-[#121215] border border-[#E5E5E7]/40 flex items-center justify-center text-3xl text-white">
        ...
        {/* Timer / Status */}
        {status === 'connected' && (
          <div className="absolute top-12 left-1/2 -translate-x-1/2 bg-[#121215]/50 px-4 py-1 rounded-full">
        ...
        {/* Local video PiP */}
        {localStream && (
          <div className="absolute top-20 right-4 w-28 h-40 rounded-2xl overflow-hidden border-2 border-white/20 bg-[#121215] shadow-lg">
            <video
              ref={localVideoRef}
              autoPlay
              playsInline
            ...
            />
            {isVideoOff && (
              <div className="w-full h-full flex items-center justify-center bg-[#121215]">
      ...
      {/* Controls */}
      <div className="w-full bg-[#121215]/80 backdrop-blur-sm pb-10 pt-6 px-6 shrink-0">
        <div className="flex items-center justify-center gap-6">
          ...
          <button
            ...
            title="Switch camera"
            className="w-14 h-14 rounded-full bg-[#121215] border border-[#E5E5E7]/40 flex items-center justify-center"
          >
