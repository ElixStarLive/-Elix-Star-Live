            ...
            <div className="flex items-center gap-2">
              <form onSubmit={handleSearch} className="flex-1 relative">
                <input 
                  type="text" 
                  placeholder="Search" 
                  className="w-full bg-[rgba(0,0,0,0.35)] text-gold-metallic placeholder-[#FFFFFF]/40 rounded-full py-0.5 pl-9 pr-9 text-sm focus:outline-none border border-white/15 focus:border-white/40"
                  value={query}
          ...
          <div className="flex flex-col flex-1 min-h-0 overflow-y-auto">
            {!normalizedQuery ? (
              ...
              <div className="space-y-4 px-4 pb-4">
                {searching && <div className="text-xs text-[#F5F5F7]/60 text-center py-3">Searching...</div>}
                      ...
                      {matchedVideos.map((v) => (
                        ...
                        >
                          <video
                            ...
                            className="w-16 h-22 rounded-lg object-cover bg-[rgba(0,0,0,0.35)] border border-[#D8D9DD]/20"
                            muted
                            playsInline
                            preload="auto"
                            onLoadedMetadata={(e) => {
                          ...
                          <div className="text-left flex-1">
                            ...
                            <div className="text-[10px] text-[#F5F5F7] mt-1">@{v.username}</div>
