      ...
      <div className="w-full max-w-[480px] h-full min-h-0 flex flex-col overflow-y-auto bg-transparent">
        ...
        {loading ? (
          <div className="flex-1 flex items-center justify-center">
            <div className="w-10 h-10 border-3 border-[#D8D9DD] border-t-transparent rounded-full animate-spin" />
          </div>
        ) : loadError ? (
          ...
          <>
            <div className="grid grid-cols-3 gap-0.5 p-0.5 flex-1 overflow-y-auto">
              {videos.map((video) => (
                <div
                  key={video.id}
                  className="aspect-[3/4] bg-transparent relative cursor-pointer group"
