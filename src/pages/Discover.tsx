        ...
        <div className="flex-1 min-h-0 overflow-y-auto w-full bg-[#111113] pb-24">
          ...
          {loading && (
            <div className="flex flex-col items-center justify-center py-20 gap-3">
              <div className="w-7 h-7 border-2 border-[#D4AF37]/20 border-t-[#FFFFFF] rounded-full animate-spin" />
...
function HashtagItem({ hashtag, index }: { hashtag: Hashtag; index: number }) {
  ...
  return (
    ...
    >
      <div className="w-9 h-9 bg-[#D4AF37]/10 rounded-xl flex items-center justify-center shrink-0">
