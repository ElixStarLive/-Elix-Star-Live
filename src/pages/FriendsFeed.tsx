...
export default function FriendsFeed() {
  ...
  return (
    <div className="h-full min-h-0 w-full flex justify-center bg-[#0B0B0E]">
      <div className="w-full max-w-[480px] h-full min-h-0 flex flex-col overflow-hidden mx-auto relative">
        ...
        <div
          className="flex-shrink-0 bg-[#0B0B0E] z-20 overflow-visible"
              ...
              >
                <div className="relative overflow-visible" style={{ width: 52, height: 52 }}>
                  ...
                  <span
                    ...
                    className="absolute bottom-0 right-0 w-4 h-4 rounded-full bg-[#5F0AE3] border-2 border-black flex items-center justify-center z-10"
                  >
            ...
            {!loading && feedLen === 0 && (
              <div className="absolute inset-0 flex flex-col items-center justify-center text-white/50 px-6 text-center">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-[#5F0AE3] text-black rounded-full text-sm font-bold mb-3"
                >
                  Add story
                </button>
                <button
