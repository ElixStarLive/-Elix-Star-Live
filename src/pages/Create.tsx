...
export default function Create() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#121215] text-white flex justify-center">
      <div className="relative w-full min-h-[100dvh] overflow-hidden">
        ...
        <div className="absolute inset-0 z-[5]" ref={mediaWrapRef}>
          {previewUrl ? (
            ...
            <div className="w-full h-full bg-[#121215] relative flex items-center justify-center" onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd}>
              <video
                ref={(el) => {
                  videoRef.current = el;
              ...
              />
              {cameraError && (
                <div className="absolute inset-0 flex items-center justify-center bg-[#121215] z-[100]">
                  <div className="text-center p-5 max-w-[280px]">
                    ...
                    <button onClick={() => { setCameraError(null); setRetryCamera((c) => c + 1); }} className="px-6 py-2.5 rounded-full bg-[#FF3B3F] text-black text-sm font-semibold active:scale-95 transition-transform">
                      Try Again
                    </button>
                  </div>
                </div>
        ...
        {countdownSeconds !== null && (
          <div className="absolute inset-0 z-[80] flex items-center justify-center bg-[#121215]">
            <div className="w-24 h-24 rounded-full bg-[#121215] border border-[#E5E5E7]/35 flex items-center justify-center">
        ...
        {toast && (
          <div className="absolute left-0 right-0 top-20 z-[90] flex justify-center px-4">
            <div className="px-4 py-2 rounded-full bg-[#121215] border border-transparent text-sm text-white/80">{toast}</div>
          </div>
        )}
        ...
        {isExporting && (
          <div className="absolute inset-0 z-[130] flex items-center justify-center bg-black/50">
            <div className="px-4 py-2 rounded-full bg-[#121215] border border-[#E5E5E7]/35 text-sm text-white/90">Processing…</div>
          </div>
        )}
