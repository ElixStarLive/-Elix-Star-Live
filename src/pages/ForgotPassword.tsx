...
export default function ForgotPassword() {
  ...
  if (success) {
    return (
      <div className="bg-[#121215] text-white flex items-center justify-center p-4 overflow-y-auto">
        <div className="w-full max-w-[420px] bg-white/5 border border-white/10 rounded-2xl p-6 text-center">
          ...
          <Link
            to="/login"
            className="inline-block w-full bg-[#FF3B3F] text-black font-bold rounded-xl py-3 text-sm text-center"
          >
            Back to Login
          </Link>
        </div>
      ...
      <div className="w-full max-w-[420px] bg-white/5 border border-white/10 rounded-2xl p-6">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-white/10 border border-white/10 rounded-xl pl-10 pr-3 py-3 text-sm text-white outline-none focus:border-[#E5E5E7]/50 placeholder:text-white/40"
          ...
          <button
            ...
            className="w-full bg-[#FF3B3F] text-black font-bold rounded-xl py-3 text-sm disabled:opacity-60"
          >
