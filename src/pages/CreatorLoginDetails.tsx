...
export default function CreatorLoginDetails() {
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-[#111111] text-white flex justify-center">
      <div className="w-full max-w-[480px] h-full bg-[#111111] flex flex-col overflow-y-auto p-4">
        ...
        {savedAccounts.length > 0 && (
          <div className="mb-6">
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-white/10 px-1">
              ...
              >
                <div className="w-10 h-10 rounded-full bg-[#111111] border border-[#C9A227]/40 flex items-center justify-center group-hover:bg-[#C9A227]/10 transition-colors relative">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-[#111111] border border-white/10 rounded-xl pl-10 pr-4 py-3 text-sm text-white placeholder-white/40/20 outline-none focus:border-[#C9A227]/50 transition-all"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-[#111111] border border-white/10 rounded-xl pl-10 pr-10 py-3 text-sm text-white placeholder-white/40/20 outline-none focus:border-[#C9A227]/50 transition-all"
            ...
            <div className="flex items-center gap-2">
              <div className="relative flex items-center">
                <input
                  ...
                  className="peer h-4 w-4 rounded-full border border-white/30 bg-transparent appearance-none checked:border-[#C9A227] checked:bg-[#FFFFFF] transition-all cursor-pointer"
                />
